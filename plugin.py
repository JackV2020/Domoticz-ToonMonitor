...
#
"""
<plugin key="JacksToonMonitor" name="Jacks Toon Monitor" author="Jack Veraart" version="3.0.0">
    <description>
...
#                    Domoticz.Log("Device: "+str(DeviceEntry))
                    ...
                    MyStatus=-1
        Domoticz.Debug('CreateDevices Read config file: '+HomeFolder+ConfigFile)
    except:
        MyStatus=-1
...
# ------- make sure all devices from the config file are there
        ...
        Domoticz.Debug('CreateDevices create/update devices')
...
#
        ...
        Domoticz.Debug('CreateDevices create/update buttons')
#
...
# --------- start delete loop for devices we do not need anymore
        ...
        Domoticz.Debug('CreateDevices delete obsolete devices')
...
# ------- end delete loop
        ...
        Domoticz.Debug('CreateDevices create/update room')
#
# (Re-)Create Room
#
...
#
        if (MyStatus == 1):
            ...
            Domoticz.Debug('CreateDevices put switches in room')
